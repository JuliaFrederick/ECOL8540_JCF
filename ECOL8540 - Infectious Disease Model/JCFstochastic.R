...
pop.size <- 300                           #total size of the population
...
####Exercise 1 - Experiment with the initial number of infecteds (Yo) and with the total population size(N)
####What effects do these have on the predictability of the epidemic?
#As the number of infecteds increase the simulations become more uniform 
#As the population size decreases the predictability of the epidemic becomes less certain
####What effects do these have on the variability of the final outbreak size?
#As the number of infecteds increase the final outbreak size becomes increasing closed to the population size faster
#and it hits the population size#As the number of infecteds increase the simulations become more uniform
#As the population size decreases final outbreak size has a higher variablity, when increasing the final size is more concrete.
...
####Exercise 2 - Simulate the stochastic SIR model using Gillespie's direct method. As before, 
####experiment with the initial number of infecteds (Yo) and with the total population size (N).
####What effects do these have on the predictability of the epidemic?
#The less individuals that are infected the higher the uncertainty of the model in predicting
#the outcomes of the epidemic.
#The larger the population the more uncertain the model and the longer it takes for the epidemic
#to run its course. 
